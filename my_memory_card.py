...
class Question():
    def __init__(self,question,right_answer,wrong1,wrong2,wrong3):
        ...
        self.wrong3 = wrong3
question_list = []
question_list.append(Question('Вопрос:Кто ты?','Не человек','Чебурашка','Чебурек','Гуманоид'))
question_list.append(Question('Вопрос:Ты умный?','Наверное','Честно,нет','Я шашлык ты о чем?','допустим'))
question_list.append(Question('Вопрос:Я умею готовить пельмены?','Да','нет','ты о чем','Как?'))
...
lb_Question = QLabel('Твои очки:')
tvoe_ochko = QLabel('Твои очки: ' + str(ochko))
...
layout_line1.addWidget(tvoe_ochko,alignment=Qt.AlignRight)
AnsGroupBox.hide() 
